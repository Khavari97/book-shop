...
$insertBookResult = $bookTable->insert($titleInput, $descriptionInput, $priceInput, $userId, $writerInput, json_encode($filesInput), json_encode($imagesInput), json_encode($tagsInput), date($DATE_TIME_FORMAT), date($DATE_TIME_FORMAT));
if (!$insertBookResult) {
