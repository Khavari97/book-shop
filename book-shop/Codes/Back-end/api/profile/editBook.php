...
//Phase 11: Update Book
$updateBookResult = $bookTable->updateById($bookIdInput, $titleInput, $descriptionInput, $priceInput, $writerInput, $filesInput, $imagesInput, $tagsInput);
if (!$updateBookResult) {
